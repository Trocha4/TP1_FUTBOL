...
def pasapalabra(cadena,palabras_seleccionadas,dicc_definiciones,lista_jugadores):
    ...
    for palabra in palabras_seleccionadas:
        ...
        if teclado==palabra:
            ...
            lista_roscos_turnos.append(nro_turno+1)
        else:
...
def volver_a_jugar(dicc_por_letras,dicc_definiciones,lista_jugadores,partidas_jugadas,maximo_partidas):
    if partidas_jugadas < maximo_partidas:
        ...
        if reiniciar == "si":
            juego(dicc_por_letras,dicc_definiciones,lista_jugadores)
            partidas_jugadas+=1    
        else:
            print("Reporte Final:")
...
def juego(dicc_por_letras,dicc_definiciones,partidas_jugadas,config,lista_jugadores):
    ...
    partidas_jugadas=volver_a_jugar(dicc_por_letras,dicc_definiciones,lista_resumen,partidas_jugadas,config[2])
